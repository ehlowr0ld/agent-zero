...
document.addEventListener('alpine:init', function () {
    ...
    Alpine.store('root', {
        ...
        isOpen: false, // Explicitly initialize modal state to closed
        reasoning: localStorage.getItem('reasoning') || 'auto',
        planning: localStorage.getItem('planning') || 'auto',
        deep_search: localStorage.getItem('deep_search') === 'on',

...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('schedulerSettings', () => ({
        ...
        async startEditTask(taskId) {
            ...
            // Set default values for context flags if they don't exist
            if (!this.editingTask.ctx_reasoning) this.editingTask.ctx_reasoning = 'auto';
            if (!this.editingTask.ctx_planning) this.editingTask.ctx_planning = 'auto';
            if (!this.editingTask.ctx_deep_search) this.editingTask.ctx_deep_search = 'off';
        ...
        async saveTask() {
            ...
            try {
                ...
                taskData = {
                    ...
                    ctx_planning: this.editingTask.ctx_planning || 'auto',
                    ctx_reasoning: this.editingTask.ctx_reasoning || 'auto',
                    ctx_deep_search: this.editingTask.ctx_deep_search || 'off',

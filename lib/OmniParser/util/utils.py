...
reader = easyocr.Reader(['en'], model_storage_directory=os.environ.get('EASYOCR_MODEL_PATH', None))
paddle_ocr = PaddleOCR(
    ...
    rec_batch_num=1024,
    det_model_dir=os.environ.get('PADDLEOCR_MODEL_PATH', None),
    rec_model_dir=os.environ.get('PADDLEOCR_MODEL_PATH', None),
    cls_model_dir=os.environ.get('PADDLEOCR_MODEL_PATH', None),
)
import time
import base64

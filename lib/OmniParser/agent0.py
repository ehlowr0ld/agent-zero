...
sys.path.append("lib/OmniParser")
sys.path.append("lib/OmniParser/util")
...
os.environ['PADDLEOCR_MODEL_PATH'] = f'{prefix}/paddleocr'
os.environ['YOLO_MODEL_PATH'] = f'{prefix}/yolo'

from lib.OmniParser.util.utils import check_ocr_box, get_yolo_model, get_caption_model_processor, get_som_labeled_img
...
# image_output_component, text_output_component = process(im, 0.05, 0.1, True, 640)
# image_output_component.save("image_output.png")
